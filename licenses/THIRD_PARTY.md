...
Clicker decodes all audio and video with FFmpeg, distributed here as separate,
...
build; nothing about Clicker prevents or penalizes that, and section 6 of the
LGPL is what guarantees it.

* Source: <https://github.com/FFmpeg/FFmpeg>, tag `n7.1.1`
* Configuration: built by `scripts/build-ffmpeg.ps1` in the Clicker source
